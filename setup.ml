...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4144b79e2caaed1a99bf96dd9dcf7e44) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Xiphos Systems Corporation - Berke Durak"];
          homepage = None;
          synopsis = "GHGSat science code (production)";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "sdmmc_analyzer.ml"})
            ];
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\016\n\141i\197\172\016\140K\216\029\128Z\139\138\021";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
